...
| 6. Accessibility and iPhone polish | in progress | The original SIXPM visual language, portrait behavior, safe-area treatment, final icon/splash direction, Dynamic Type reflow, route focus, minimum target sizing, and an offline snapshot are locally verified. VoiceOver, reduced-motion, permission-denial, and native-system-sheet verification remain. |
