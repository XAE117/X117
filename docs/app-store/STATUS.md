...
| 6. Accessibility and iPhone polish | in progress | The original SIXPM visual language, portrait behavior, safe-area treatment, final icon/splash direction, Dynamic Type reflow, route focus, minimum target sizing, offline snapshot, future-only showing guard, and native share-sheet cancellation are locally verified. VoiceOver, reduced motion, permission denial, Calendar with a configured account, local-notification scheduling, physical-device proof, and a live versioned catalog endpoint remain. |
